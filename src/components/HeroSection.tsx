...
export default function HeroSection() {
    ...
    return (
        <section id="home" className="relative pt-36 pb-16 md:pt-48 md:pb-36 overflow-hidden bg-[#0a1930] min-h-[90vh] flex flex-col justify-center">
            {/* Background Image */}
            <Image
                src={heroBg}
            ...
            <div className="container mx-auto px-4 lg:px-8">
                <div className="max-w-5xl mx-auto text-center space-y-6 md:space-y-8">
                    {/* Eyebrow */}
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm text-[10px] md:text-xs font-bold tracking-[0.2em] text-blue-300 uppercase shrink-0">
                        <span className="w-1.5 h-1.5 rounded-full bg-blue-400 animate-pulse"></span>
                        {t.eyebrow}
                    </div>

                    <h1 className="text-[2.1rem] sm:text-5xl md:text-7xl lg:text-[5.5rem] font-extrabold tracking-tight leading-[1.1] md:leading-[0.95] text-white">
                        <span className="block mb-2 md:mb-4">{t.title1}</span>
                    ...
                    <div className="space-y-3 md:space-y-4 pt-2 md:pt-4">
                        <h2 className="text-lg md:text-2xl font-semibold text-white/80 max-w-4xl mx-auto leading-relaxed">
                            {t.sub}
                        </h2>
                        <p className="text-sm md:text-lg text-slate-400 max-w-3xl mx-auto leading-relaxed font-medium">
                            {t.desc}
                        </p>
                    </div>

                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6 md:pt-10 relative z-10">
                        <Link href="#contact" className="w-full sm:w-auto px-10 py-4 md:py-5 bg-white text-[#0a1930] rounded-2xl text-base font-bold transition-all shadow-[0_0_40px_rgba(255,255,255,0.15)] hover:shadow-[0_0_60px_rgba(255,255,255,0.25)] flex items-center justify-center gap-2 hover:-translate-y-1">
                            {t.btn1}
                            <ArrowRight className="w-5 h-5" />
                        </Link>
                        <Link href="#core-solutions" className="w-full sm:w-auto px-10 py-4 md:py-5 bg-white/5 hover:bg-white/10 backdrop-blur-2xl border border-white/15 text-white rounded-2xl text-base font-bold transition-all items-center justify-center gap-2 hidden sm:flex hover:-translate-y-1">
                            {t.btn2}
                    ...
                    {/* Trust Bar */}
                    <div className="mt-12 md:mt-16 pt-8 md:pt-10 border-t border-white/10 max-w-4xl mx-auto">
