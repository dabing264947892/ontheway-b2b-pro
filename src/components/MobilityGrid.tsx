...
export default function MobilityGrid() {
    ...
    const text = {
        EN: {
            ...
            box2Desc: "API direct connects to global low-cost carriers, maximizing margin potential and content diversity.",
            box2Suffix: "LCC APIs",
            box3Title: "Global Group Ticketing",
            box3Desc: "First-hand group ticket resource pool covering all major regions with specialized fulfillment support.",
        ...
        ZH: {
            ...
            box1Suffix: "直连航司",
            box2Title: "低成本航空矩阵",
            box2Desc: "直连全球优质低成本航空运力库，充分释放代理商的内容竞争力与利润潜力。",
            box2Suffix: "家航司 API",
            box3Title: "一手全球团队资源",
            box3Desc: "覆盖全球五大洲，提供极具壁垒的一手团队机位优势资源与专项履约支持。",
            box3Suffix: "大洲团队覆盖"
        }
    };
    const t = text[lang];
